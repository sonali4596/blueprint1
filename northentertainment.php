...
<title>BluePrint</title>
 <meta charset="utf-8" >
  ...
  <meta name="viewport" content="width=device-width, initial-scale" />
   <link rel="stylesheet" href="northentertainment1.css"> 
...
<body>
            ...
            <div class="main">
                <div class="sa100621112018">
                    ...
                    <div class="heading">
                        ...
                        <h1> Welcome To entertainment of north   </h1>
                    </div>
                    </div>
    ...
    function set(a,b,c){
          ...
          data.open("get","northentertainment_dataretrieve.php?start="+a+"&& limit="+b);
          data.send();
